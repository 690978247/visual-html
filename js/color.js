(function () {
	...
	Colorpicker.prototype = {
		init(opt) {
			...
			this.historycolor = ["rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)"]
            this.password = '100%'
	...
	this.elem_colorPalette1.addEventListener("click", function (e) {
		...
		render: function () {
			var tpl =
				...
				<div class="asdasd" style="position: fixed; top: 0px; right: 0px; bottom: 0px; left: 0px;"></div>
...
user-select: none; ">
				  ...
				  <img  src="../colorimg/nocolor.png" alt="" style="width:100%;height:100%">
					...
					<div class="flexbox-fix" style="display: flex;height:70px">
						...
						<input  class='hex' style='border:none;position:absolute;color:#eeeeee;font-size:12px;width:80px;height:20px;background:#171717;left:90px;top:10px;box-sizing: content-box;padding:0' value='#000000'/>		
						 <img src = '../colorimg/xq.png' style="width:12px;height:13px;position:absolute;top:43px;left:10px;cursor:pointer"  class='xq'>
					...
					<div style='width:215px;height:130px;padding:10px 0px; padding-left:10px;display:none' class='color-palette'>
						${this.getPaletteColorsItem()}
					</div>
					
					<div class="colorpicker-pancel" style=" position:relative;box-sizing: initial; width: 205px; font-family: Menlo;padding:10px;">
			...
			<div class="flexbox-fix" style="display: flex;align-items: center;height: 160px;width:10px;position:absolute; right:10px;top:13px">
					...
					<div class='passcolor' style='background: linear-gradient(to right,rgba(0, 0, 0, 0),rgb(0, 0, 0));position:absolute;width:160px;height:14px;border-radius:4px;'></div>
						...
						<div style='width:215px;height:20px;padding:10px 0px; padding-left:10px;padding-top:0px' class='color-palette1'>
