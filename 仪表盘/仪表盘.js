...
function DashEchartsFun(BarChartData){
    let data = []
...
function DashinitEchart(data,DashName,type){
    ...
    setTimeout(()=>{
        ...
        function initAxis(text){
            ...
            console.log('sss',BarChartData.option.Variable.Range.axisLineArr)
            let Dom = $('.axisDom')
            let dom = ''
            let dom1 = ''
            ...
            for(let i=0;i<axisLineLength;i++){
                ...
                dom = dom + `<div class="axisBox" style="margin-left:30px;margin-top:10px;">
                    <div class="showLin">区间${i+1}</div>
                    <div class="showLin" style="margin-left:15px">颜色</div>
                    <div id="axisColor${i+1}" class="colorBlock showLin"></div>
                ...
                if(i!=axisLineLength-1 ){
                    ...
                    style="left:${425 * (i+1)/Number(axisLineLength) - 13}px;background:${BarChartData.option.SelectedColorScheme[i]}"></div>`
                }
                axisLineArr.push(value)
            }
        ...
        function judgeRe(i,dom,value,axisLineLength){
            ...
            console.log('aaa',BarChartData.option.Variable.Range.axisLineArr)
        }
        //区间事件绑定
        function AxisClickFun(){
            let axisLineLength = BarChartData.option.Variable.Range.axisLineArr
            console.log('ggg',BarChartData.option.Variable.Range.axisLineArr)
            ...
            colorpicker.render({
                ...
                $('body').on('mousemove',function(e){
                    ...
                    if(moveShow){
                        ...
                        if(e.clientX - domLeft <= 425 && e.clientX - domLeft >= 0){
                            if(moveIndex !=0){
